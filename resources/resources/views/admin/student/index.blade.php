                                                        ...
                                                        @foreach($settings as $setting)
                                                                ...
                                                                <td class="action-icons">
                                                                    <ul class="icon-button d-flex">
                                                                        <li>
                                                                            <a class="dropdown-item"   href="{{url('admin/students/show/'.$setting->id)}}" role="button"><i class="fa-solid fa-eye"></i></a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="dropdown-item"   href="{{url('admin/students/'.$setting->id.'/edit')}}" role="button"><i class="fa-solid fa-pen"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
