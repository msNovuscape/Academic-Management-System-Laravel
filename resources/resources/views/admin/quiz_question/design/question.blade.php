...
<div class="row quiz-add mt-4 pt-4 add-more-block" id="add-more-block{{$id}}">
    <div class="col-md-12 d-flex justify-content-end">
        <a onclick="getCancel({{$id}})"><img src="{{url('images/cancel-icon.png')}}" alt="cancel-icon"></a>
    </div>
    <div class="col-md-6 d-flex" id="mainblock{{$id}}">
        <div class="col-md-3">
            <label for="">Question Type</label>
        </div>
        <div class="col-md-9">
            <div class="input-group">
                <select name="question_type[]" id="question_type{{$id}}" class="form-control" onchange="getQuestionDom({{$id}})" required>
                ...
                <input type="number" name="count[]" value="{{$id}}" style="display: none">
                <span>
    ...
    <div id="suppotingblock{{$id}}" class="row">
        ...
        <div class="col-md-12 d-flex" id="question-block{{$id}}">
            <div class="col-md-12" >
                <div class="d-flex mt-4">
                    ...
                    <div class="col-md-11">
                        <div class="input-group">
                            <input type="text" name="question{{$id}}" class="form-control"  placeholder="Write your question here" required>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 d-flex mt-4">
            ...
            <div class="col-md-9">
                <div class="input-group">
                    <select name="no_of_option[]" class="form-control" id="no_of_option{{$id}}" onchange="getOption({{$id}})">
