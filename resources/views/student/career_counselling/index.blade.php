          ...
          <div class="block-body sd-progress-block">
                <div class="progress sd-progress mt-3">
                    @if($setting->admission->sCounselling)
                        <div class="progress-bar bg-success pb" style="width: {{$setting->admission->sCounselling->studentCounsellingStatuses->count() * 20}}% " id='my-progressbar' role="progressbar"  aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                    @else
