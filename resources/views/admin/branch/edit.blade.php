                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        <div class="block-header p-4">
                            <h3>Edit Branch</h3>
                            <p class="ms-4">Fill the following fields to edit a Branch</p>
                        ...
                        <div class="row p-4">
                            <div class="col-12 table-responsive grid-margin">
                                {!! Form::open(['url' => 'branches/'.$setting->id,'method'=>'Post']) !!}
                                <div class="row">
                                        ...
                                        <div class="form-group batch-form">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
                                                            <input name="address" type="text" class="form-control" value="{{$setting->address}}" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group batch-form">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
                                                            <input name="phone_no" type="text" class="form-control" value="{{$setting->phone_no}}" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
