                ...
                <div class="row">
                    <div class="card-heading d-flex justify-content-between">
                        <div>
                            <h4>Shpw Role</h4>
                            <p>
                                You can Show give access according to the following roles.
                            </p>
                        </div>
                                            ...
                                            <div class="col-12 table-responsive table-details">
                                                <table class="table" id="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="tblform-check">
                                                                <input name="create_p[]" class="form-check-input-master checkbox-create" type="checkbox" @if($role->role_premissions->where('permission_id', $permissions->where('slug', 'create_'.$setting->table_name)->first()->id)->count() > 0) checked @endif  value="{{$permissions->where('slug', 'create_'.$setting->table_name)->first()->id}}">
                                                                <label class="form-check-label" for="flexCheckDefault"></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="tblform-check">
                                                                <input name="show_p[]" class="form-check-input-master checkbox-show" type="checkbox" @if($role->role_premissions->where('permission_id', $permissions->where('slug', 'show_'.$setting->table_name)->first()->id)->count() > 0) checked @endif value="{{$permissions->where('slug', 'show_'.$setting->table_name)->first()->id}}">
                                                                <label class="form-check-label" for="flexCheckDefault"></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="tblform-check">
                                                                <input name="update_p[]" class="form-check-input-master checkbox-update" type="checkbox" @if($role->role_premissions->where('permission_id', $permissions->where('slug', 'update_'.$setting->table_name)->first()->id)->count() > 0) checked @endif value="{{$permissions->where('slug', 'update_'.$setting->table_name)->first()->id}}">
                                                                <label class="form-check-label" for="flexCheckDefault"></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="tblform-check">
                                                                <input name="delete_p[]" class="form-check-input-master checkbox-delete" type="checkbox" @if($role->role_premissions->where('permission_id', $permissions->where('slug', 'delete_'.$setting->table_name)->first()->id)->count() > 0) checked @endif value="{{$permissions->where('slug', 'delete_'.$setting->table_name)->first()->id}}">
                                                                <label class="form-check-label" for="flexCheckDefault"></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="tblform-check">
                                                                <input name="report_p[]" class="form-check-input-master checkbox-report" type="checkbox" @if($role->role_premissions->where('permission_id', $permissions->where('slug', 'report_'.$setting->table_name)->first()->id)->count() > 0) checked @endif value="{{$permissions->where('slug', 'report_'.$setting->table_name)->first()->id}}">
                                                                <label class="form-check-label" for="flexCheckDefault"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
