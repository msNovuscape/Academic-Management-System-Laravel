                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        <div class="block-header p-4">
                            ...
                            <p class="ms-4">Fill the following fields to update a Zoom Link</p>
                        ...
                        <div class="row p-4">
                            <div class="col-12 table-responsive grid-margin">
                                {!! Form::open(['url' => 'zoom-links/'.$setting->id,'method' => 'POST']) !!}
                                <div class="row">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="course_id" class="form-control" required>
                                                                ...
                                                                @foreach($courses as $course)
                                                                    @if($course->id == $setting->course_id)
                                        ...
                                        <div class="form-group batch-form">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
                                                            <input type="text" name="link" class="form-control" value="{{$setting->link}}" placeholder="link" autocomplete="off" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
