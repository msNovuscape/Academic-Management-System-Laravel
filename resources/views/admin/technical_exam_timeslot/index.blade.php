@extends('layouts.app')
@section('title')
    <title>Technical Exam Timeslot Lists</title>
@endsection
@section('main-panel')
                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Technical Exam Timeslot Lists</h4>
                                {{-- <p>
                            ...
                            <div class="card-wrap form-block p-0">
                                <div class="block-header bg-header d-flex justify-content-between p-4">
                                    <div class="d-flex flex-column">
                                        <h3>Technical Exam Timeslot Table</h3>
                                    </div>
                                                                ...
                                                                <td class="action-icons">
                                                                    <ul class="icon-button d-flex">
                                                                        {{-- @if(Auth::user()->customMenuPermission('show_course_materials')) --}}
                                                                            <li>
                                                                                <a class="dropdown-item" data-bs-target="#modalEditExam{{$setting->id}}" data-bs-toggle="modal"  href="#" role="button" data-bs-toggle="tooltip" data-bs-title="edit"><i class="fa-solid fa-pen"></i></a>
                                                                            </li>
                                                                        {{-- @endif --}}
    ...
    @include('admin.technical_exam_timeslot.timeslot_modal')
    <!-- Edit time table Modal -->
    @include('admin.technical_exam_timeslot.timeslot_modal_edit')
@endsection
@section('script')
            ...
            $.confirm({
                ...
                buttons: {
                    tryAgain: {
                        ...
                        btnClass: 'btn-red',
                        action: function(){
                            window.location = Laravel.url+'/technical_exam_timeslot/delete/'+id;
                        }
                    },
                    close: function () {
                    }
