<table class="table" id="attendance_table">
    ...
    @foreach($settings as $setting)
        <tr id="student_row{{$setting->student->id}}" @if($setting->student->admission->batch_transfer_status == 1) class="batch-transfer-indication" @endif>
            <td>
                <div class="tblform-check">
            ...
            <td class="action-icons">
                <ul class="icon-button d-flex">
                    <li>
                        <a class="dropdown-item"   href="{{url('admissions/attendances/'.$setting->student->admission->id)}}" role="button" data-bs-toggle="tooltip" data-bs-title="view"><i class="fa-solid fa-eye"></i></a>
                    </li>
                </ul>
            </td>
        </tr>
