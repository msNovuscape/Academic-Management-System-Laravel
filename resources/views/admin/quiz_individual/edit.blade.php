                    ...
                    <div class="card-wrap form-block p-0">
                        ...
                        <div class="row p-4">
                            <div class="col-sm-12 col-md-12 stretch-card sl-stretch-card">
                                {!! Form::open(['url' => 'quiz_individual/'.$setting->id,'method' => 'POST']) !!}
                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" value="{{$setting->admission->user->name}}">
                                                                    <input type="hidden" name="admission_id" required value="{{$setting->admission->id}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="input-group">
                                                                    <select  id="course_id" class="form-control" required onchange="getBatch()">
                                                                        ...
                                                                        @foreach($courses as $course)
                                                                            <option value="{{$course->id}}" @if($setting->admission->batch->time_slot->course_id == $course->id) selected @endif>{{$course->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <select name="quiz_id" id="quiz_id" class="form-control" required>
                                                                        <option value="{{$setting->quiz_id}}"  class="option-quiz" selected>{{$setting->quiz->name}}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
