...
<!-- Add Course Modal -->
<div class="modal fade" id="modalAddCourse" tabindex="-1" aria-labelledby="ModalLabelAddCourse" aria-hidden="true">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <input name="name" type="text" class="form-control form-control-sm" id="inlineFormInputGroup" placeholder="Course Name" required/>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <label for="exampleInputEmail1">Course Code</label>
                                            <div class="col-md-12 mt-4">
                                                <input name="code" type="text" class="form-control form-control-sm" id="inlineFormInputGroup" placeholder="Course Code" required/>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
