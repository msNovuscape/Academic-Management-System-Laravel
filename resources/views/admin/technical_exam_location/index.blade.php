@extends('layouts.app')
@section('title')
    <title>Exam Location Lists</title>
@endsection
@section('main-panel')
                            ...
                            <div class="card-wrap form-block p-0">
                                <div class="block-header bg-header d-flex justify-content-between p-4">
                                    <div class="d-flex flex-column">
                                        <h3>Technical Exam Location Table</h3>
                                    </div>
                                    {{-- @if(Auth::user()->customMenuPermission('create_technical_exam_location')) --}}
                                        <div class="add-button">
                                            <a class="nav-link" href="{{url('technical_exam_location/create')}}"><i class="fa-solid fa-book-open"></i>&nbsp;&nbsp;Add Location</a>
                                        </div>
                                    {{-- @endif --}}
                                </div>
                                <div class="row">
