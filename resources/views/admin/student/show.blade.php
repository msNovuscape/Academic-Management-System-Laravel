            ...
            <div class="row profile-top">
                <div class="col-md-4 profile-col">
                    <div class='profile-general'>
                        ...
                        <div class='profile-desc'>
                            <h1 class="mb-0">{{$setting->admission->user->name}}</h1>
                ...
                <div class="col-md-4 course-col">
                    <div class="course-general">
                        <h1 class="mb-0">{{$setting->admission->batch->time_slot->course->name}}</h1>
...
@section('script')
    ...
    @include('admin.student.attendence.attendance_script')
@endsection
