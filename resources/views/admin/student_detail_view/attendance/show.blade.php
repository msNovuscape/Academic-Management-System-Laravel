    ...
    <div class="container-fluid">
        <div class="row">
            <div class="filter-btnwrap justify-content-between">
                {!! Form::open(['url' => 'admissions/attendances/'.$setting->id, 'method' => 'GET']) !!}
                    <div class="d-flex">
                            <div class="input-group">
                                <span>
                                    <i class="fa-solid fa-magnifying-glass"></i>
                                </span>
                                <input type="text" class="form-control getDate" id="inputText" placeholder="Search" name="date"/>
                            </div>
                        ...
                        <div class="refresh-group mx-2">
                            <a onclick="getResetLink('{{Request::segment(1)}}','{{Request::segment(2)}}','{{Request::segment(3)}}')">
            ...
            <div class="col-md-8">
                <h1>Attendance Log Details</h1>
                <div class="attendence-log  justify-content-between">
                    <p>Daily Attendance Log details</p>
                </div>
                <div class="row">
                        ...
                        <div class="record-bottom">
                            <table class="table table-borderless">
                                <tr>
                                    <td>Present</td>
                                    <td>:</td>
                                    <td>{{$attendances->where('status',1)->count()}} Days</td>
                                </tr>
                                <tr>
                                    <td>Absent</td>
                                    <td>:</td>
                                    <td>{{$attendances->where('status',2)->count()}} Days</td>
                                </tr>
                                <tr>
                                    <td>Hours</td>
                                    <td>:</td>
                                    <td>{{$attendances->where('status',1)->count() * ((strtotime($setting->batch->time_slot->time_table->end_time) - strtotime($setting->batch->time_slot->time_table->start_time)) / 3600)}} Hours</td>
                                </tr>
                            </table>
                        </div>
                    </div>
